        ...
        <div className="rounded-xl p-5 border shadow-xl max-w-screen-lg mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-10">
            ...
            <img
              ...
              className="object-contain w-full md:w-96 rounded-xl"
            />
          </div>
        </div>
      </div>
